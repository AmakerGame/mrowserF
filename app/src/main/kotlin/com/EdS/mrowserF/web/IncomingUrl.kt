...
/**
 * Pure: vets a URL that reached mrowserF from outside — another app's `ACTION_VIEW` intent, or
...
object IncomingUrl {
    ...
    /** @return the page a VIEW intent asks mrowserF to open, or null if it asks for nothing
