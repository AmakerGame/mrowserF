...
Run: `./gradlew test --tests "com.EdS.mrowserF.player.SubtitleCueParserTest"`
...
Run: `./gradlew test --tests "com.EdS.mrowserF.player.ActiveCueFinderTest"`
...
`import com.EdS.mrowserF.stream.SubtitleTrack` and `import android.net.Uri` if they become unused
...
`import com.EdS.mrowserF.stream.SubtitleTrack`, delete that import and rebuild.
